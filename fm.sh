# Escrito por Heron Trindade de oliveira para a disciplina de Shell Script


#!/bin/bash
#
# Script com funções utilizando o comando CASE
#


principal() {           # Função principal 
    clear               # limpa a tela
    echo "[1] Mostrar a localização atual do usuário no sistema de arquivos"             # mostra as opções que serão
